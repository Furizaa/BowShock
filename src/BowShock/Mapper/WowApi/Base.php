...
namespace BowShock\Mapper\WowApi;

use BowShock\Mapper\NotFoundException,
	BowShock\WowApi\Region,
	BowShock\WowApi\ApiException;
...
abstract class Base
{
    ...
    {
        $this->region = Region::REGION_EUROPE;
    }
    ...
    {
        return Region::getRegionApiUri($this->region)
            . $this->method;
    }
    ...
    protected function call()
    {
        ...
        if ($result->getStatus() == 404) {
            ...
            throw new NotFoundException("Wow Api Document {$this->getUrl()} not found!");
        }
        if ($result->getStatus() !== 200) {
            require_once 'BowShock/WowApi/Exception.php';
            throw new NotFoundException("Wrong return code {$result->getStatus()}!");
        }
        ...
        try {
            ...
            require_once 'BowShock/WowApi/Exception.php';
            throw new ApiException('Unnable to parse result: ' . $e->getMessage(), 0, $e);
        }
